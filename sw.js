        ...
        return cache.match(storageUrl).then(response =>{
            return response || fetch(request).then(networkResponse =>{
                ...
                if(requestUrl.pathname === "/restaurants"){
                    ...
                    if(requestUrl.pathname.substring(1,12) != "restaurants" 
                        && requestUrl.pathname.substring(1,8) != "reviews") {
                        cache.put(storageUrl, networkResponse.clone()); // add the other response to cache like map marks 
                    }
                }
